          ...
          <div className="p-6  border-gray-200">
            <form onSubmit={onSubmit}>
              <div className="font-display mb-4">
                <label className="block mb-2 text-sm font-medium text-gray-100 dark:text-white">
                  Taqyryp <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
              ...
              <div className="font-display mb-8">
                <label className="text-l text-gray-100">
                  Mätın<span className="text-red-500">*</span>
                </label>
                <textarea
                  rows="18"
                  type="text"
              ...
              <button className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-gray-900 bg-green-200 rounded-lg hover:bg-green-400  font-display uppercase">
                Jañartu
              </button>
            </form>
          </div>
