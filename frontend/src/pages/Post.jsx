...
import { isPostSaved, savePost } from "../utils";
          ...
          <article className="mx-auto w-full max-w-3xl border format format-sm sm:format-base lg:format-lg format-blue dark:format-invert bg-gray-800 rounded-3xl p-10">
            <header className="mb-4 lg:mb-6 not-format px-10 py-5">
              <div className="flex  -ml-1 mb-8 not-italic justify-between">
                ...
                >
                  <img
                    ...
                    src={post?.user_photo || defaultAvatar}
                    alt="avatar photo"
                  />
                  <div className="">
              ...
              <div className=" mb-4 mt-5">
                <h2 className="text-center text-3xl font-extrabold leading-tight text-gray-900 lg:mb-6 lg:text-4xl sm:text-xs md:text-2xl dark:text-white">
                  {post?.title}
                </h2>
              </div>
            </header>
            ...
            <div className="w-full mt-5 mb-5 flex flex-row-reverse gap-x-3.5">
              ...
              >
                {isSaved ? (
                  <BsBookmarkFill className="w-6 h-6 top-0" />
                ) : (
              ...
              <button onClick={() => fnLikePost()} className="">
