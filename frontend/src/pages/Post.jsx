          ...
          <header className="mb-4 lg:mb-6 not-format px-10 py-5">
              <address className="flex items-center mb-6 not-italic">
                  <div className="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white ">
                      ...
                      <div className=''>
                          <a href="#" rel="author" className="text-xl font-bold text-gray-900 dark:text-white">{post.user_id}</a>
                          <p className="text-base font-light text-gray-500 dark:text-gray-400">Avtordin BIO</p>
                          <p className="text-base font-light text-gray-500 dark:text-gray-400"><time>{new Date(post.createdAt).toLocaleString('en-US')}</time></p>
                      </div>
                  </div>
              </address>
