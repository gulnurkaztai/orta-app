              ...
              <form onSubmit={onSubmit}>
                <div className="flex flex-wrap mt-10 pl-3">
                  <div className="flex flex-col ">
                    <p className="mt-4 mb-5 flex text-center w-30 pr-10">
                      Esımıñ
                    </p>
                ...
                <div>
                  <button className="bg-green-200 py-2 px-9 font-display text-gray-900  hover:bg-gray-800 hover:text-white rounded-xl transition duration-300 uppercase">
                    Update
                  </button>
                </div>
              </form>
